...
import org.trichter.app.features.ble.data.local.createLocalRunsRepository
...
val bleDataModule = module {
    ...
    single<LocalRunsRepository> { createLocalRunsRepository() }
}
...
val bleDomainModule = module {
    ...
    factoryOf(::SaveRun)
    factoryOf(::SaveRunLocally)
    factoryOf(::SearchUsers)
    factoryOf(::GetCurrentUser)
    factoryOf(::GetLocalRuns)
    factoryOf(::DeleteLocalRun)
    factoryOf(::UpdateLocalRunSyncStatus)
    factoryOf(::UpdateLocalRunUser)
}