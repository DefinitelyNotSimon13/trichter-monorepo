  ...
  return (
    <>
      ...
      <p>
        ...
        Geschäftsleitung der Trichter. Eine Nutzung der Internetseiten der
        Trichter ist grundsätzlich ohne jede Angabe personenbezogener Daten
      ...
      <p>
        ...
        Übereinstimmung mit den für die Trichter geltenden landesspezifischen
      ...
      <p>
        Die Trichter hat als für die Verarbeitung Verantwortlicher zahlreiche
      ...
      <p>
        Die Datenschutzerklärung der Trichter beruht auf den Begrifflichkeiten,
      ...
      <p>Deutschland</p>
      <p>Tel.: +491778799440</p>
      <p>E-Mail: simon21.blum@gmail.com</p>
      <p>Website: trichter.hauptspeicher.com</p>

      <h4>3. Cookies</h4>
      <p>
        Die Internetseiten der Trichter verwenden Cookies. Cookies sind
      ...
      <p>
        Durch den Einsatz von Cookies kann die Trichter den Nutzern dieser
      ...
      <p>
        Die Internetseite der Trichter erfasst mit jedem Aufruf der
      ...
      <p>
        ...
        Trichter keine Rückschlüsse auf die betroffene Person. Diese
        ...
        erhobenen Daten und Informationen werden durch die Trichter daher
      ...
      <ul className="list-none">
        ...
        <li>
          ...
          <p>
            ...
            Trichter gespeichert sind, veranlassen möchte, kann sie sich hierzu
            jederzeit an einen Mitarbeiter des für die Verarbeitung
            Verantwortlichen wenden. Der Mitarbeiter der Trichter wird
            veranlassen, dass dem Löschverlangen unverzüglich nachgekommen wird.
          </p>

          <p>
            Wurden die personenbezogenen Daten von der Trichter öffentlich
            ...
            so trifft die Trichter unter Berücksichtigung der verfügbaren
            ...
            Mitarbeiter der Trichter wird im Einzelfall das Notwendige
            veranlassen.
          </p>
        </li>
        <li>
          ...
          <p>
            ...
            bei der Trichter gespeichert sind, verlangen möchte, kann sie sich
            hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung
            Verantwortlichen wenden. Der Mitarbeiter der Trichter wird die
        ...
        <li>
          ...
          <p>
            ...
            betroffene Person jederzeit an einen Mitarbeiter der Trichter
            wenden.
          </p>
        </li>
        <li>
          ...
          <p>
            Die Trichter verarbeitet die personenbezogenen Daten im Falle des
          ...
          <p>
            Verarbeitet die Trichter personenbezogene Daten, um Direktwerbung zu
            ...
            Widerspricht die betroffene Person gegenüber der Trichter der
            Verarbeitung für Zwecke der Direktwerbung, so wird die Trichter die
          ...
          <p>
            ...
            Verarbeitung personenbezogener Daten, die bei der Trichter zu
          ...
          <p>
            ...
            Person direkt an jeden Mitarbeiter der Trichter oder einen anderen
        ...
        <li>
          ...
          <p>
            ...
            der betroffenen Person, trifft die Trichter angemessene Maßnahmen,
      ...
      <p>
        ...
        <a href="https://www.wbs.legal/" rel="nofollow">
          Datenschutz Anwalt Christian Solmecke
        </a>{" "}
        erstellt.
      </p>
    </>
