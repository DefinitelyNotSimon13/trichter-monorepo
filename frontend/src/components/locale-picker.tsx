...
export function LocalePicker() {
  ...
  return (
    ...
    >
      <div
        className={`rounded-full px-2.5 py-1 text-xs font-medium transition-colors ${(currentLocale ?? "en") === "en"
      ...
      <div
        className={`rounded-full px-2.5 py-1 text-xs font-medium transition-colors ${currentLocale === "de"
            ? "bg-muted text-foreground"
            : "text-muted-foreground"
          }`}
      >
